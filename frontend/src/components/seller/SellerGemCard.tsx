...
import { Gem } from "../../types/seller.types";
  ...
  return (
    <div className="group flex flex-col rounded-[var(--radius-xl)] overflow-hidden border border-border bg-card shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <div className="flex flex-col flex-1 p-4 gap-2">
        <h3 className="font-semibold text-foreground text-base leading-snug font-[Playfair_Display] line-clamp-1">
          {gem.name}
        </h3>
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button
            ...
            className={`text-xs font-semibold px-3 py-1.5 rounded-[var(--radius-lg)] transition-opacity duration-150 ${
              gem.inStock
